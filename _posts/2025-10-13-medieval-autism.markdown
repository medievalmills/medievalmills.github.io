...
> *This post was originally published on the [Exeter Medieval Studies blog](https://sites.exeter.ac.uk/medievalstudies/2025/10/13/medieval-autism/).*

The strands really started to come together about two and a half years ago. In early 2023, I’d been working at Exeter for a few years post-PhD, and had become increasingly involved in supporting the University of Exeter’s work with autistic students. Having received a late diagnosis of autism myself — something I’ve written about in more detail [elsewhere](https://edwardmills.uk/2017/04/17/my-experience-with-aspergers.html) — I found myself very keen to ensure that incoming students (in all subjects) were supported in confronting the challenges (and opportunities) that come with attending university while neurodivergent. Lo and behold: Edward explaining the interlocking sources of student support, with reference to [the Muppets](https://wonkhe.com/blogs/supporting-neurodiverse-students-through-the-transition-to-university/).
...
The resulting talk is available online in [video form](https://www.youtube.com/watch?v=P9_Lh_kUGE0), as it was delivered the wonderfully-named ‘special interest group’, REsearchers and Students On Neurodiversity ([REaSON](https://reasongroup.org)). Following an incredibly rewarding collaborative process, I’m also delighted to be able to say that a revised version of it is also now out in [open-access chapter form](https://www.degruyterbrill.com/document/doi/10.1515/9781501517341-010/html), as part of the collection *Towards an Accessible Academy: Perspectives from Disabled Medievalists*. My chapter’s in great company, and I’m enormously grateful to have been able to be a small part of an intervention that’s both urgently needed and exceptionally well put together.
